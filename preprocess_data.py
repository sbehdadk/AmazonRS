...
class dataloader:
    ...
    def __init__(self,train_path = '/media/sina/Daten/AmazonRS/dataset/Electronics/images_background',
                test_path = '/media/sina/Daten/AmazonRS/dataset/Electronics/images_evaluation'):
...
if __name__=='__main__':
    data = dataloader(train_path = '/media/sina/Daten/AmazonRS/dataset/Electronics/images_background',
                     test_path = '/media/sina/Daten/AmazonRS/dataset/Electronics/images_evaluation')
    data.saveImagePaths()
